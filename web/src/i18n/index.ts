...
const dict = {
  zh: {
    ...
    'posts.empty': '暂无文章',
    'posts.invalidPage': '页码必须在 1 到 10000 之间',
    'posts.count': '篇文章',
    'post.toc': '目录',
    'post.updated': '更新于',
    'post.views': '次阅读',
    ...
    'search.invalid': '搜索关键词不能包含控制字符，且最多为 100 个字符',
    'search.failed': '搜索服务暂时不可用，请稍后重试',
    'friends.title': '友情链接',
  ...
  en: {
    ...
    'posts.invalidPage': 'Page must be between 1 and 10000',
    'posts.count': 'posts',
    'post.toc': 'Contents',
    ...
    'search.invalid': 'Search terms cannot contain control characters and must be at most 100 characters',
